 ...
 * 
 * @author lzb
 * @date 2020年8月17日下午4:41:48
 */
@Service("JOINROOM")
public class NettyEventJoinRoomMsgServiceImpl implements INettyEventService {
	...
	public Result<Void> run(NettyMsg msg) {
		...
		return nettyService.joinRoom(roomId, msg.getSendAccount());

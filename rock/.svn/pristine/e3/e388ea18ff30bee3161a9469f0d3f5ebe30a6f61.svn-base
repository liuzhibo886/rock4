...
public class MySwaggerApiModelPropertyPropertyBuilder extends ApiModelPropertyPropertyBuilder {

	public MySwaggerApiModelPropertyPropertyBuilder(DescriptionResolver descriptions) {
		super(descriptions);
	}

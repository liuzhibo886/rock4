...
public class MySwaggerSchemaPluginsManager extends SchemaPluginsManager {
	private final PluginRegistry<ModelPropertyBuilderPlugin, DocumentationType> propertyEnrichers;

	@Autowired
	MySwaggerApiModelPropertyPropertyBuilder myApiModelPropertyPropertyBuilder;

	public MySwaggerSchemaPluginsManager(
